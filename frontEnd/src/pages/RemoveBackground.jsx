import {  Download as DownloadIcon, Eraser, Sparkles } from 'lucide-react';
    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
            ...
            <img src={content} alt="image" className="w-full h-full"/>
              <a
                href={content}
                download="processed-image.png" // the name of the downloaded file
                className="absolute top-2 right-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600"
              >
                <DownloadIcon/>
              </a>
